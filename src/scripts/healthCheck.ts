...
function printRecommendations(result: any) {
    ...
    if (result.checks.database.status === 'error') {
        ...
        console.log(`${colors.red}${colors.bright}\nStorage Issue:${colors.reset}`);
        console.log('   - Check STORAGE_DIR in .env (optional)');
        console.log('   - Ensure the storage folder is writable');
        console.log('   - Default location: ./data\n');
    }
