...
console.log(`${colors.cyan}${colors.bright}  ✅ Polymarket Data Lab - Installed!${colors.reset}`);
...
console.log(`   2. ${colors.green}npm run build${colors.reset}          # Compile the dashboard`);
console.log(`   3. ${colors.green}npm start${colors.reset}              # Start Analys!\n`);
